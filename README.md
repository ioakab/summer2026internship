...
| `hOmega` | 0.5–1.0 GeV | matches the fill condition itself (`0.5 < m < 1.0`); the distribution rises all the way to the upper edge with **no visible ω peak yet** — see [Known limitations](#known-limitations) |
